...
public class LoginScreen extends Activity {
    ...
    public void createAllFiles(){
        ...
        createInternalFile("PID_" + pid + "_TwoDFittsData_Internal.csv", "Two Dimensional Fitts Task", "Group,PId,Block,Trial,Amplitude (pixel),Amplitude (mm),Width (pixel),Width (mm),Direction (degree),Select, Pressure,Touch-Down X-cor,Touch-Down Y-cor, Lift-Up X-cor,Lift-Up Y-cor,,start Timestamp,First Touch-Down Timestamp,First Touch-Down Time Taken(ms),First Lift-Up Timestamp,First Lift-Up Time Taken(ms), Final Touch-Down Timestamp, Final Touch-Down Time Taken(ms),Final Lift-Up Timestamp, Final Lift-Up Time Taken(ms),First Re-Entry,TRE(/attempt)");
